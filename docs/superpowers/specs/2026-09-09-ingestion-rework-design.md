...
|---|---|---|---|
| 2 | Prices + performance | `security-prices`, `security-daily-history`, `security-price-history`, `security-performance`, `instrument-prices`, `instrument-performance`, `sector/country/group-performance`, `fx-rates` | The throughput pain. One yfinance pool; batch 12; total return kept; `prices`/`instruments` overlay retired into `listing` + `security_price` (curated rows get `is_curated`). |
