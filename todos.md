...
- [ ] **Coverage: prioritise by SECURITIES PER SOURCE, not by region.** Measured 2026-09-06 from
      ...
      | India | **645** | NSE XBRL | **IMPLEMENTED 2026-09-06 (PR #316), symbol resolution fixed same day (PR #321)** |
...
- [x] **2026-09-20 — BUILT AND ROLLED: partition raw to the provider's request grain.** Decided 2026-09-19
  ...
  per lane (cron / observable + `data_version_changed` / `on_missing`). **Steps 1-3 DONE, not yet rolled.**
  #52: `merge_on` makes a partition extend rather than be replaced; `prune_dagster_storage`
